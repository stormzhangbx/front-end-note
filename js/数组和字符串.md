...
- [数组和字符串](#%E6%95%B0%E7%BB%84%E5%92%8C%E5%AD%97%E7%AC%A6%E4%B8%B2)
  - [1 数组](#1-%E6%95%B0%E7%BB%84)
    ...
    - [1.12 shift() 和 pop()](#112-shift-%E5%92%8C-pop)
    - [1.13 unshift() 和 push()](#113-unshift-%E5%92%8C-push)
...
```js
var arr = [{name: 'q', age: 20}]
var o1 = {name: 'w', age: 21}
var o2 = {name: 'e', age: 22}
console.log(arr.push(o1, o2)) // 3
console.log(arr) // [{name: 'q', age: 20}, {name: 'w', age: 21}, {name: 'e', age: 22}]
```
